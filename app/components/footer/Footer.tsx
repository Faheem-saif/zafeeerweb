        ...
        <footer className="text-gray-600 body-font">
          <div className="container px-5 py-24 mx-auto flex md:items-center lg:items-start md:flex-row md:flex-nowrap flex-wrap flex-col">
            <div className="w-64 flex-shrink-0 md:mx-0 mx-auto text-center md:text-left">
              ...
              <p className="mt-2 text-sm text-gray-500">Place to converts your dreams into beautiful reality</p>
            </div>
            <div className="flex-grow flex flex-wrap md:pl-20 -mb-10 md:mt-0 mt-10 md:text-left text-center">
              <div className="lg:w-1/3 md:w-1/2 w-full px-4">
                ...
                <nav className="list-none mb-10">
                  <li> <Link href={"/services/graphicDesign"}>Graphic Design</Link></li>
                  <li><Link href={"/services/webDevelopment"}>Website Development </Link></li>
              ...
              <div className="lg:w-1/3 md:w-1/2 w-full px-4">
                <h2 className="title-font font-medium text-gray-900 tracking-widest text-sm mb-3">Task Details</h2>
                <nav className="list-none mb-10">
                  <li>  <Link href={"/taskDetails/graphicDesigning"}> <div
                  >Graphic Designer</div></Link></li>
                  <li>    <Link href={"/taskDetails/webDevelopment"}>
                    <div>Web Development</div>
                  </Link></li>
                  <li> <Link href={"/taskDetails/contantWriting"}>
                    <div >Content Writing </div>
                  </Link></li>
                  <li><Link href={"/taskDetails/videoEditing"}>
              ...
              <div className="lg:w-1/3 md:w-1/2 w-full px-4">
                <h2 className="title-font font-medium text-gray-900 tracking-widest text-sm mb-3">Our Links</h2>
                <nav className="list-none mb-10">
                  <li>
                  ...
                  <li>
                    <a className="text-gray-600 hover:text-gray-800">bihance</a>
                  </li>
                  <li>
                    <a className="text-gray-600 hover:text-gray-800">Whatspp</a>
                  </li>
                </nav>
              </div>
            </div>
          ...
          <div className="bg-gray-100">
            <div className="container mx-auto py-4 px-5 flex flex-wrap flex-col sm:flex-row">
              <p className="text-gray-500 text-sm text-center sm:text-left">&copy; {new Date().getFullYear()} Myunipixel —
